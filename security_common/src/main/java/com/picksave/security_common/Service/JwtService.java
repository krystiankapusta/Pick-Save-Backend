...
public class JwtService {
    ...
    public String generateToken(String email) {
        return buildToken(new HashMap<>(), email, jwtProperties.getExpirationTime());
    }

    public String generateToken(Map<String, Object> extraClaims, String email) {
        return buildToken(extraClaims, email, jwtProperties.getExpirationTime());
    }
    ...
    private String buildToken(
        ...
        logger.info("Building token for user with email: {}", email);
